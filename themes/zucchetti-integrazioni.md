...
- 2026-09-16 [Veneta Cucine] Integrazione Winsap: tracciati dati — walkthrough dei tracciati JSON standard per anagrafiche (chiave = codice fiscale, non matricola, per via di duplicati), timbrature (batch 24h, campi obbligatori CID/timestamp/direzione) e assenze (flusso solo in ingresso per ora, holiday key lasciata vuota in attesa del flusso di ritorno); obiettivo attivare senza sviluppo se la struttura rientra nello standard dei connettori. Non chiaro se "Winsap" sia Zucchetti o sistema terzo — vedi Osservazioni aperte — [meetings/veneta-cucine/2026-09-16-integrazione-winsap-tracciati-dati.md]
...
- Veneta Cucine (2026-09-16): non è confermato se "Winsap" (nome così come reso dalla trascrizione) sia un modulo Zucchetti o un sistema terzo distinto — verificare con Gabriele prima di continuare a taggare i meeting su questa integrazione sotto questo tema.
